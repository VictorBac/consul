...
- [Ingress gateways](#ingress-gateways) enable services to accept traffic from outside the Consul service mesh that originates from your organizational network.
- [Terminating gateways](#terminating-gateways) enable you to route traffic from services in the Consul service mesh to other services in your organizational network.
...
to services within the mesh. To accept ingress traffic from the public internet, use Consul's
